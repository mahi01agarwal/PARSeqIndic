...
def main():
    ...
    parser.add_argument('--image-folder', help='Folder containing images to read')
    ...
    results = []
    for fname in tqdm(image_files, desc='predicting labels...'):
    ...
    if args.output_file:
        with open(args.output_file, 'w') as f:
            for fname, label in tqdm(results, desc='writing results to text file...'):
